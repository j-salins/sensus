...
<main>
  <header
    class="container bg-snaccent self-center flex flex-col bg-fixed bg-cover bg-left bg-no-repeat" style="height: 80vh; background-image: url({header_bg})"
  >
    <nav>
  ...
  <section id="praescriptus" class="container bg-sn-light" >
    <div class="md:pb-64 bg-cover md:bg-[length:70%_auto] bg-right-top md:bg-right md:bg-center bg-no-repeat" style="background-image: url({about_bg})">
    ...
    <div class="sensus-list my-20 mx-auto py-20 max-w-5xl flex flex-col items-center justify-center gap-10 shadow-hard">
  ...
  <section id="makers" class="container bg-sn-dark md:p-20">
    <div class="md:w-2/3">
